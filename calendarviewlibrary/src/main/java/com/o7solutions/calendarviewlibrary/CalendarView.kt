...
import com.o7solutions.calendarviewlibrary.Util.dp
import com.o7solutions.calendarviewlibrary.Util.months
import com.o7solutions.calendarviewlibrary.Util.weekDays
...
class CalendarView : LinearLayout, CalenderViewInterface {
    ...
    var events: ArrayList<Calendar>? = arrayListOf()
    ...
    override fun withEvents(events: ArrayList<Calendar>?,eventDotColor: Int?): CalendarView {
        this.events = events

...
import com.vanshika.tasktrack.databinding.FragmentRewardsBinding
...
class RewardsFragment : Fragment() {
    ...
    var binding : FragmentRewardsBinding ?= null
    ...
    private fun updateStars() {
        val starCount = sharedPreferences.getInt("stars", 0)
        binding?.tvRewards?.setText("$starCount")
    }
}